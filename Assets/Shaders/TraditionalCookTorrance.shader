...
Shader "Custom/TraditionalCookTorrance"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // Computes the scalar specular term for CookTorrance BRDF
            half3 DirectBRDFSpecularCookTorrance(BRDFData brdfData, half3 normalWS, half3 lightDirectionWS, half3 viewDirectionWS)
            {
                ...
                // for debugging
                float Ddenom = lerp(1, brdfData.roughness2, NoH * NoH);
            ...
            // Based on com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl
            half3 LightingPhysicallyBasedCookTorrance(BRDFData brdfData, 
                ...
                half3 normalWS, half3 viewDirectionWS)
            {
                ...
                brdf += DirectBRDFSpecularCookTorrance(brdfData, normalWS, lightDirectionWS, viewDirectionWS);

                return brdf * radiance;
            }

            // Based on com.unity.render-pipelines.universal/ShaderLibrary/Lighting.hlsl
            half3 LightingPhysicallyBasedCookTorrance(BRDFData brdfData, Light light, half3 normalWS, half3 viewDirectionWS)
            {
                return LightingPhysicallyBasedCookTorrance(brdfData, light.color, light.direction, light.distanceAttenuation * light.shadowAttenuation, normalWS, viewDirectionWS);
            }
            ...
            half4 LitPassFragment(Varyings input) : SV_Target
            {
                ...
                color += LightingPhysicallyBasedCookTorrance(brdfData, mainLight, normalWS, viewDirectionWS);
                ...
                for (int i = 0; i < additionalLightsCount; ++i)
                {
                    ...
                    color += LightingPhysicallyBasedCookTorrance(brdfData, light, normalWS, viewDirectionWS);
